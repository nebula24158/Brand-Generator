...
app.post("/submit", (req, res) => {
  ...
  function generateName() {
    var randomIndex1 = Math.floor(Math.random() * adj.length);
    var randomIndex2 = Math.floor(Math.random() * noun.length);

    var randomAdj = adj[randomIndex1];
    var randomNoun = noun[randomIndex2];

    var Name = `${randomAdj} ${randomNoun}`;

    return Name;
  }
  res.render("index.ejs", {randomName : generateName()});
